...
if (isset($_POST['btn_addDriver'])) {
    ...
    $action = 'Registered ' . $firstname . ' ' . $middlename . ' ' . $lastname . ' to driver list';
                            ...
                            <form id="addStudentForm" action="" method="post">
                                <div class="">
                                    <fieldset>
                                        ...
                                        <input name="btn_addDriver" id="signup" class="btn btn-block btn-primary" type="submit" value="Add User" />
                                    </fieldset>
                            </form>
                        </div>
                    </div>
